...
public class AdminController {
    ...
    public record ServiceView(UUID id, UUID organizationId, String serviceKey, String displayName, BigDecimal inputPricePerMillion, BigDecimal outputPricePerMillion, Currency currency, FailoverPolicy failoverPolicy, RetryPolicy retryPolicy, boolean allowDegraded, boolean enabled, TemperaturePolicy temperaturePolicy, BigDecimal temperatureValue) { static ServiceView from(LlmService item) { return new ServiceView(item.getId(), item.getOrganizationId(), item.getServiceKey(), item.getDisplayName(), item.getInputPricePerMillion(), item.getOutputPricePerMillion(), item.getCurrency(), item.getFailoverPolicy(), item.getRetryPolicy(), item.isAllowDegraded(), item.isEnabled(), item.getTemperaturePolicy(), item.getTemperatureValue()); } }
