...
public final class AdminDtos {
    ...
    public record CreateProject(@NotNull UUID organizationId, @NotBlank @Size(max = 120) String name) { }
    public record CreateNode(@NotNull UUID organizationId, @NotBlank @Size(max = 120) String name, @Size(max = 500) String description, String connectionMode, String labelsJson) { }
    public record CreateEndpoint(@NotNull UUID nodeId, @NotNull RuntimeType runtimeType, @NotBlank @Size(max = 500) String baseUrl, String apiToken) { }
    ...
    public record CreateService(@NotNull UUID organizationId, @NotBlank @Pattern(regexp = "[a-z0-9][a-z0-9-]{0,119}") String serviceKey,
    ...
    public record CreateTarget(@NotNull UUID deploymentId, @Min(1) int priority, @Min(1) Integer weight, boolean degraded, @Min(1) Integer maxConcurrencyOverride) { }
