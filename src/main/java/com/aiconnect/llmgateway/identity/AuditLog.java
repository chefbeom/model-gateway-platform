...
public class AuditLog {
    ...
    public AuditLog(UUID organizationId, UUID actorUserId, String action, String resourceType, String resourceId, String detailJson) {
        this.organizationId = organizationId; this.actorUserId = actorUserId; this.action = action; this.resourceType = resourceType; this.resourceId = resourceId; this.detailJson = detailJson;
    }
}
