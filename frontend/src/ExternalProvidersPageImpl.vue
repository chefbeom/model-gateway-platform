...
type Model = { id:string; providerModelId:string; displayName:string; contextLength?:number; maxConcurrency:number; capabilitiesJson:string; healthStatus:string; enabled:boolean; inputPricePerMillion?:number; outputPricePerMillion?:number; currency?: 'KRW' | 'USD' }
...
const modelForm = ref({ providerModelId:'', displayName:'', compatibilityKey:'', contextLength:128000, maxConcurrency:20, capabilitiesJson:'[]', inputPricePerMillion:0, outputPricePerMillion:0, currency:'KRW' as 'KRW' | 'USD' })
